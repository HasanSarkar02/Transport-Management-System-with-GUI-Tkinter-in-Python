        ...
        def update():
          if sd: 
            ...
            if(len(Pno.get())!=0):
              ...
              tkinter.messagebox.showerror("Error", "No record selected for update.")
...
if __name__ == '__main__':
    import pasDatabase
    pasDatabase.passengerData()  # Initialize the database and create the table if it doesn't exist
